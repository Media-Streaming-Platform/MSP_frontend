  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black pt-20">
      ...
      <div className="container mx-auto px-6 py-8 relative z-10">
        ...
        {/* Footer CTA
        <div className="text-center">
          <div className="bg-gradient-to-r from-red-600/20 to-blue-600/20 rounded-2xl p-8 border border-gray-700/50">
            <h3 className="text-2xl font-bold text-white mb-4">Never Miss a Service</h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Subscribe to get notifications for upcoming live streams and access to our video library.
            </p>
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <button className="bg-gray-700 hover:bg-gray-600 text-white px-8 py-4 rounded-lg font-semibold transition-all border border-gray-600">
                📺 Visit Video Library
              </button>
            </div>
          </div>
