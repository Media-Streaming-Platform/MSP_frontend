...
export default function LivePage() {
  const videoRef =
    "https://unprorogued-unformalistic-macie.ngrok-free.dev/live/stream/";
  const hlsRef = useRef<Hls | null>(null);
  const reactionCounterRef = useRef(0);
  const animationDelaysRef = useRef<{ [key: number]: string }>({}); // Fixed: Store delays in ref
  ...
  // Your HLS stream URL
  const m3u8Url =
    "https://462dx4mlqj3o-hls-live.wmncdn.net/jnvisiontv/0e1fd802947a734b3af7787436f11588.sdp/chunks.m3u8";
  ...
  const addReaction = (type: string) => {
    ...
    // Generate animation delay once and store it
    animationDelaysRef.current[id] = `${(id % 5) * 0.1}s`; // Fixed: Deterministic delay based on ID

    setReactions((prev) => [...prev, { type, id }]);
    setTimeout(() => {
      setReactions((prev) => prev.filter((r) => r.id !== id));
      // Clean up the stored delay
      delete animationDelaysRef.current[id];
    }, 3000);
  };
      ...
      <div className="container mx-auto px-6 py-8 relative z-10">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-5xl font-bold text-white mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
            Web-cam Livestreaming
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Join our live Christian streaming service 
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl overflow-hidden shadow-2xl border border-gray-700/50">
              ...
              <div className="relative">
                ...
                className="w-full h-120"
                  src="https://unprorogued-unformalistic-macie.ngrok-free.dev/live/stream/"
          ...
          <div className="space-y-6">
            ...
            <div
              className={`space-y-6 ${showChat ? "block" : "hidden lg:block"}`}
            >
              {/* Stream Stats Card */}
              ...
              <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="p-3 bg-gray-700/30 rounded-lg border-l-4 border-red-600"
                    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50">
            ...
            <p className="text-gray-300 mb-6 text-lg leading-relaxed">
              Join us for an uplifting worship experience featuring
              powerful messages from Scripture, inspiring worship music, and
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50">
            ...
            <p className="text-gray-300 mb-6 text-lg">
              Having trouble with the stream? We`&apos;`re here to help you get the
              ...
              <div className="flex items-center gap-4 p-3 bg-gray-700/30 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Try reloading the page if stream stops
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-3 bg-gray-700/30 rounded-lg">
