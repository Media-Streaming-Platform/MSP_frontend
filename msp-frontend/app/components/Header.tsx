        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/" className="flex items-center gap-2" aria-label="Media Streaming Platform Home">
              ...
              <span className="text-white font-bold text-xl hidden sm:block">Media Streaming Platform</span>
            </Link>
                  ...
                  {searchResults.map((media) => (
                    ...
                    >
                      <div 
                        ...
                        style={{ 
                          backgroundImage: `url('${apiService.getThumbnailUrl(media)}')`,
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-gray-400 text-sm truncate">
                          {media.categories?.name} • {apiService.formatMediaType(media.type)}
                        </p>
          ...
          {activeFilter !== 'all' && (
            <div className="flex items-center gap-2 mb-3 px-2">
              ...
              <div className="flex items-center gap-1 bg-red-600 px-3 py-1 rounded-full">
                <span className="text-white text-sm">{getActiveFilterName()}</span>
                <button 
                  onClick={clearFilter}
